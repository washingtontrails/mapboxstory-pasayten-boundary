...
var config = {
    ...
    chapters: [
        ...
        },
        {
            id: 'boundary3',
            alignment: '',
            title: 'Years of Partnerships',
            image: imageRoot + 'Partners.jpg',
            imageCredit: 'Rachel Wendling',
            description: 'Tackling trails in the Pasayten is no small feat. We’ve been fortunate to work alongside several other organizations who are ensuring the Boundary Trail and its primary access points remain open to hikers. In addition to the land managers - the Okanogan-Wenatchee National Forest - the Pacific Northwest Trail Association (PNTA), Back Country Horsemen of Washington (BCHW) and Pacific Crest Trail Association (PCTA) have all played an integral part in maintaining these trails.',
            location: {
              center: [-120.48902, 48.79047],
              zoom: 9.86,
              pitch: 0.50,
        ...
        },
        {
            ...
            imageCredit: 'Owen Vogeli',
            description: 'In 2020,  we sent a volunteer vacation out to this breathtaking location. They redefined the trail through a notoriously rocky area, where the trail had become almost invisible in places. Our crew re-established the route around the Clutch Creek and Windy Creek junctions, and removed over a dozen large boulders and tripping hazards from the trail along the rocky ridgeline.',
            location: {
        ...
        },
        {
         ...
         },
         {
             ...
             description: 'In 2022, WTA volunteers visited Lake Creek for the first time in a decade, making several notable improvements. We cleared over 3.5 miles of trail, cut and removed 40 logs from the trail corridor, and shimmied 20 boulders shimmied out of the trail tread. Plenty of logs remain to the north of the lakes for a <a href="https://www.wta.org/volunteer/schedule/workparty/a2m2K00000AWj7X/">future trip.</a>',
             location: {
             ...
             },
             {
              ...
              },
              {
               ...
               },
               {
                   ...
                   description: 'Despite evading the fire so many other trails in the Pasayten saw, Robinson Creek still requires regular maintenance to keep water damage at bay and blowdowns in check. Seasonal storms continue to knock down even healthy trees, so in 2016, a tough volunteer crew headed out on a 50-mile loop to clear trees, working alongside Forest Service crews to cut out over 200 trees from Robinson Creek. And in 2018, one of our intrepid youth volunteer vacation crews ventured out along Robinson to rebuild some key water management structures — including check steps, which help slow down water runoff and prevent trail erosion. There\'s more to do, so we\'re <a href="https://www.wta.org/volunteer/schedule/workparty/a2m2K00000AWj8p/">heading back in 2023.</a>',
                   location: {
                ...
                },
                {
                 ...
                 },
                 {
                  ...
                  },
                  {
                      ...
                      image: '',
                      imageCredit: '',
                      description: 'The Pasayten is special to so many hikers. Whether you take a day hike up to Black Lake or a weeklong trek connecting several valleys and passes, you’ll find a wilderness experience unlike any other in Washington. <p>As wildfire season continues to grow longer and hotter across Washington, locations like the Pasayten are in desperate need of long-term investments to ensure future generations can enjoy these benefits.</p>',
                      location: {
                        center: [-120.48902, 48.79047],
                        zoom: 9.86,
                        pitch: 0.50,
